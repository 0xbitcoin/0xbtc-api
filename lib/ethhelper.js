    ...
    static async  connectToContract(web3,  callback)
    {
      ...
      var decimals = Math.pow(10,8);
       var renderData = {
         ...
         blocksPerReadjustment: _BLOCKS_PER_READJUSTMENT,
         ...
         currentEthBlock: current_eth_block,
         ethBlocksSinceLastDifficultyPeriod: eth_blocks_since_last_difficulty_period,
